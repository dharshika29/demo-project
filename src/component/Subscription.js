        ...
        <div className={styles.right}>
          <div className={styles.flower}>
            ...
            <div className={styles.list}>
              ...
              <ul>
                <li>
                  Is a great way to create a pleasant atmosphere and leave a
                  good impression on your guests and customers. Fresh floral
          ...
          <div className={styles.selectives}>
            ...
            <div className={styles.flowerForms}>
              <div className={styles.formContainer}>
                ...
                <button className={styles.checkout}>BUTTON</button>
              </div>
            </div>
          </div>
        </div>
