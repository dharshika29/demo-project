    ...
    <div>
        ...
        <div className="row">
            <div className="col m-5">
                ...
                <span className='text-dark'>SHIPPING 
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-right" viewBox="0 0 16 16">
                        <path fill-rule="evenodd" d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708"/>
                    </svg>
                </span>
                ...
                <div className='d-flex justify-content-between w-5'>
                   <input id={style.but} className='border p-3' type="text" placeholder="Street" />
                   <input id={style.but} className='border p-3' type="text" placeholder="Apartment Number" />
                </div><br />
                <input type="checkbox" /><span className='m-3'>I don't know the address, please call the recipient.</span>
                <br/><br />
                <button className="btn btn-dark text-center w-100">Continue to Payment</button><br />
                <hr />
                <span id={style.sp1} >3 Payment</span><br /><hr />
            </div>
